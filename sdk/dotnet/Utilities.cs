...
namespace Pulumi.Local-exec
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Local-exec.version.txt");
    ...
    internal sealed class Local-execResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Local-execResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
